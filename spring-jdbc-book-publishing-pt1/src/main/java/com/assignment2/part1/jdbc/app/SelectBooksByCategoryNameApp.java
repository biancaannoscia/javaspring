...
public class SelectBooksByCategoryNameApp {
	...
	public static void main(String[] args) {
        ...
        //Here we initialize the dao class, and execute find all books with category name = "Fantasy"
        BookCategoryDaoImpl bookCategoryDaoImpl = ctx.getBean(BookCategoryDaoImpl.class);
        List<Book> books = bookCategoryDaoImpl.findAllBooksByCategoryName("Fantasy");
